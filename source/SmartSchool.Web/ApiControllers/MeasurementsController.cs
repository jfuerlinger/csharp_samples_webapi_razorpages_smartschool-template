...
namespace SmartSchool.Web.ApiControllers
{
    ...
    public class MeasurementsController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public IActionResult GetMeasurementForSensorAt(int sensorId, string date, string time)
        {
            throw new NotImplementedException();
        }
        ...
        public IActionResult PostMeasurement([FromBody] Object measurementDto)  //! DTO verwenden
        {
            throw new NotImplementedException();
        }
